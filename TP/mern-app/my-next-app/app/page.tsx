...
import IndexNavbar from "/root/my-next-app/app/components/Navbars/IndexNavbar.js";
import Footer from "/root/my-next-app/app/components/Footers/Footer.js";
...
export default function ToDoList() {
  return (
    ...
    <div>
     ...
     <Item isDone={false} name="make a real index page"/>
     <Item isDone={false} name="more routes"/>
    </div>
  );
}
